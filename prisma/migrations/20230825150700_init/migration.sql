...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicDepertmentId_fkey" FOREIGN KEY ("academicDepertmentId") REFERENCES "academic_department"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "faculties" ADD CONSTRAINT "faculties_academicDepertmentId_fkey" FOREIGN KEY ("academicDepertmentId") REFERENCES "academic_department"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
